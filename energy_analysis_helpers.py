...
# def main():
	...
	# filename ='energy.log'
	# prefixed = [direname for direname in os.listdir(current_dir) if direname.startswith("test")]
	# for testdir in prefixed:
	# 	processed = read_energy_log(os.path.join(testdir,filename))
